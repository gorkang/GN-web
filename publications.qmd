...
include-in-header: 
  - text: <script type='text/javascript' src='https://embed.altmetric.com/assets/embed.js'></script>
---
...
```{r, results='asis'}
# https://docs.altmetric.com/badges/getting-started/
  
show_paper <- function(DF) {
  paste0("<div class='altmetric-embed' data-badge-type='donut' data-doi='", DF$DOI2[[1]], "' style='float: left; margin-right: 15px; margin-bottom: 5px;'></div>", 
